...
const ScrollExpandMedia = ({
  ...
  // The looping video plays continuously, regardless of scroll position.
  useEffect(() => {
  ...
  const expandH = mobile ? 260 : 400;
  const mediaWidth = 300 + scrollProgress * expandW;
  const mediaHeight = 380 + scrollProgress * expandH;
  const textTranslateX = scrollProgress * (mobile ? 60 : 150);
        ...
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              <div
                className="absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-none rounded-[4px]"
                style={{
                  width: `${mediaWidth}px`,
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <p
                      className="u-label text-[10px] text-[#8a8a92]"
              ...
              >
                ...
                <motion.h2
                  className="u-head text-4xl md:text-5xl lg:text-6xl text-center transition-none"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
